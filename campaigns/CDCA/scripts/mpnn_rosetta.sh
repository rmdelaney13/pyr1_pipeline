#!/bin/bash
#SBATCH --job-name=LigandMPNN_CDCA_rosetta
#SBATCH --output=LigandMPNN_CDCA_rosetta_%A_%a.out
#SBATCH --error=LigandMPNN_CDCA_rosetta_%A_%a.err
...
OMIT_JSON="/projects/ryde3462/software/pyr1_pipeline/campaigns/CDCA/mpnn/omit_rosetta.json"
BIAS_JSON="/projects/ryde3462/software/pyr1_pipeline/campaigns/CDCA/mpnn/bias_rosetta.json"
