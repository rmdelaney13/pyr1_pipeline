...
def design(pose, resfile, ref_seq, fnr_bonus):
    ...
    # Enable backbone and side-chain flexibility for chain A
    chain_a_selector = pyrosetta.rosetta.core.select.residue_selector.ChainSelector("A")
    mmf.add_bb_action(pyrosetta.rosetta.core.select.movemap.mm_enable, chain_a_selector)
    mmf.add_chi_action(pyrosetta.rosetta.core.select.movemap.mm_enable, chain_a_selector)

    # Disable backbone and side-chain flexibility for chain C
    chain_c_selector = pyrosetta.rosetta.core.select.residue_selector.ResidueIndexSelector("182-400")
    mmf.add_bb_action(pyrosetta.rosetta.core.select.movemap.mm_disable, chain_c_selector)
    mmf.add_chi_action(pyrosetta.rosetta.core.select.movemap.mm_disable, chain_c_selector)
