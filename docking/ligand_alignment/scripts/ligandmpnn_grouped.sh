...
#SBATCH --mem=50G                              # Total memory per task
#SBATCH --time=00:30:00                        # Time limit hrs:min:sec
#SBATCH --array=1-36                          # Array range: 900 jobs total
...
# Define Variables
# ------------------------------
PDB_DIR="/scratch/alpine/ryde3462/cholic_acid_design/design_out1"   # Directory with .pdb files
OUTPUT_BASE="/scratch/alpine/ryde3462/cholic_acid_desgin/mpnn_output_2"              # Base directory for LigandMPNN outputs
