...
def aggregate_pass_score_repacked(pass_score_repacked_dirs,
    ...
    """
    Aggregate pass_score_repacked_* directories into a single directory
    ONE LEVEL ABOVE output_base (i.e. next to pass_).
    """

    # Go one directory up from pass_
    parent_dir = os.path.dirname(output_base.rstrip("/"))
    final_dir = os.path.join(parent_dir, final_dir_name)
    ...
    print(f"All pass_score_repacked files aggregated into {final_dir}")
...
def main(argv):
    ...
    aggregate_pass_score_repacked(pass_score_repacked_dirs, num_passes, output_base, array_index)
