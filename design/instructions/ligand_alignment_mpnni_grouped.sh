...
# Define Variables
# ------------------------------
PDB_DIR="/scratch/alpine/ryde3462/DCA_design_normal/filtered_1" # Directory with .pdb files
OUTPUT_BASE="/scratch/alpine/ryde3462/DCA_design_normal/mpnn_output_2_max"              # Base directory for LigandMPNN outputs
...
for (( i=START_INDEX; i<=END_INDEX; i++ )); do
	...
	--bias_AA_per_residue /projects/ryde3462/software/LigandMPNN/ligand_alignment_mpnn/scripts/instructions/LCA_bias_AA_per_residue.json \
        --pack_side_chains 0 \
