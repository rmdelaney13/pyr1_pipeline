#!/bin/bash
#SBATCH --job-name=LigandMPNN_CDCA            # Job name
#SBATCH --output=LigandMPNN_CDCA_%A_%a.out    # Standard output and error log
#SBATCH --error=LigandMPNN_CDCA_%A_%a.err
...
# CDCA-specific configs (Rosetta/docked PDB numbering)
OMIT_JSON="/projects/ryde3462/pyr1_pipeline/design/mpnn/CDCA_omit_rosetta.json"
BIAS_JSON="/projects/ryde3462/pyr1_pipeline/design/mpnn/CDCA_bias_rosetta.json"
