...
TIERS=(
    ...
    "tiers/tier3_pnas_cutler.csv|--batch-size 50 --docking-repeats 30 --relax-per-task 20 --workers 8"
    "tiers/tier4_LCA_screen.csv|--batch-size 50 --docking-repeats 30 --relax-per-task 20 --workers 8"
    "tiers/tier5_artificial.csv|--batch-size 50 --docking-repeats 30 --relax-per-task 20 --workers 8"
)
